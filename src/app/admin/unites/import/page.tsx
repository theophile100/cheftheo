...
export default async function ImportUnite() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mt-8 flex flex-col gap-3 rounded-3xl bg-white p-6 shadow-lg shadow-zinc-900/5 dark:bg-zinc-900">
        <h2 className="font-bold text-zinc-900 dark:text-zinc-50">Format attendu (JSON uniquement)</h2>
